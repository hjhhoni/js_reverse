function watermark(settings) {
    ...
    var maskElement = document.getElementById('app-main-div');

    var marks = document.getElementsByClassName('mask_div');
    if (marks.length > 0) {
        $('.mask_div').remove();
    }
    ...
    defaultSettings.watermark_width = page_width > 1300 ? (page_width > 1600 ? page_width / 3 : page_width / 2) : window.innerWidth;
    //水印数量自适应元素区域尺寸
