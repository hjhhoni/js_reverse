    ...
    (function(factory) {
        ...
        ( /** @lends <global> */ function($) {
            ...
            function _fnBuildAjax(oSettings, data, fn) {
                ...
                if (oSettings.fnServerData) {
                    ...
                    oSettings.fnServerData.call(instance,
                        //oSettings.sAjaxSource+"&page="+oSettings._iDisplayStart+"&size="+oSettings._iDisplayLength,
            ...
            DataTable.defaults = {
                 ...
                 * [jQuery.ajax]( ) allowing fine control
                 ...
                 *  @type function
                 *  @member
                 *  @param {string} source   source to obtain the data from (`ajax`)
                 ...
                 * superseded by that provided through `ajax`, which should be used instead.
                 *
                 * Set the   method that is used to make the Ajax call for server-side
            ...
            DataTable.models.oSettings = {
                ...
                /**
                 * Send the XHR   method - GET or POST (could be PUT or DELETE if
                 * required).
                 * Note that this parameter will be set by the initialisation routine. To
                 * set a default use {@link DataTable.defaults}.
                 *  @type string
            ...
            $.extend(true, DataTable.ext.renderer, {
                pageButton: {
                    _: function(settings, host, idx, buttons, page, pages) {
                        ...
                        //addGoPage($("#fundlist_paginate"));
                    }
                }
            });

            //	function addGoPage(container){
            //		var node = $('<input>', {
            //			'style': "width:60px;",
            //			'name': "goInput",
            //			'id': "goInput",
